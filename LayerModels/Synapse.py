...
class Synapse(BaseSynapseModel):
    ...
    def __init__(self, params_dict, access_buffers, dt,
        ...
        self.num_comps = params_dict['w'].size
        self.params_dict = params_dict
        self.access_buffers = access_buffers

        self.debug = debug
        self.LPU_id = LPU_id
        self.dtype = params_dict['w'].dtype
    ...
    def pre_run(self, update_pointers):
        if self.params_dict.has_key('init_individual_input'):
            cuda.memcpy_dtod(int(update_pointers['individual_input']),
                             self.params_dict['init_individual_input'].gpudata,
                             self.params_dict['init_individual_input'].nbytes)
...
__global__ void update(
    ...
    %(r)s* g_r,
    %(w)s* g_w,
    %(individual_input)s* g_individual_input)
{
    ...
    %(r)s r;
    %(w)s w;
    %(individual_input)s individual_input;
    ...
    for(int i = tid; i < num_comps; i += total_threads)
    {
        ...
        individual_input = r * w;

        g_individual_input[i] = individual_input;
    }
}
}
"""
    ...
    def get_update_func(self, dtypes):
        ...
        type_dict.update({'fletter': 'f' if type_dict['w'] == 'float' else ''})
