...
class TL2(BaseLayerModel):
    updates = ['r']
    accesses = ['h']
    params = ['prefs','slope','bias']
    internals = {}
    ...
    def __init__(self, params_dict, access_buffers, dt,
        ...
        self.num_comps = params_dict['prefs'].size
        self.params_dict = params_dict
        self.access_buffers = access_buffers

        self.debug = debug
        self.LPU_id = LPU_id
        self.dtype = params_dict['prefs'].dtype
...
"""
    ...
    def get_update_func(self, dtypes):
        ...
        type_dict.update({'fletter': 'f' if type_dict['prefs'] == 'float' else ''})
